...
x86_64_c_src_files := $(shell find src/impl/x86_64 -name *.cpp)
x86_64_c_obj_files := $(patsubst src/impl/x86_64/%.cpp, build/x86_64/%.o, $(x86_64_c_src_files))
...
$(x86_64_c_obj_files): build/x86_64/%.o : src/impl/x86_64/%.cpp
	mkdir -p $(dir $@) && \
